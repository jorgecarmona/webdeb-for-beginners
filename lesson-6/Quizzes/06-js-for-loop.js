...
console.log(count1); // Answer should be:
...
console.log(reversedName2); // Answer should be:
...
console.log(sum3); // Answer should be:
...
console.log(count5); // Answer should be:
...
console.log(product6); // Answer should be:
...
console.log(length10); // Answer should be:
...
console.log(count11); // Answer should be:
...
console.log(reversedTown12); // Answer should be:
...
console.log(sum13); // Answer should be:
...
console.log(count15); // Answer should be:
...
console.log(product16); // Answer should be:
...
console.log(length20); // Answer should be:
